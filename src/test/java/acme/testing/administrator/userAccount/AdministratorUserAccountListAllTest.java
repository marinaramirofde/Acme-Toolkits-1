...
public class AdministratorUserAccountListAllTest extends TestHarness{
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/administrator/user-account/list-all.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
    public void positiveTest(final int recordIndex, final String roleList, final String username, final String name, final String surname, final String email) {
        ...
        super.clickOnMenu("Administrator", "List user accounts");
