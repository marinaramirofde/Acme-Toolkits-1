...
public class PatronComponentListTest extends TestHarness{
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/patron/item/list-components.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveTest(final int recordIndex, final String typeEntity, final String name, final String code, final String technology, final String description, final String retailPrice, final String link) {
		...
		super.clickOnMenu("Patron", "List all components");
