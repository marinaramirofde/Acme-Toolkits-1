package acme.testing.inventor.announcement;
...
public class InventorAnnouncementListTest extends TestHarness{
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/announcement/list-recent.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
