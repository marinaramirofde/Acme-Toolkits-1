...
<acme:form readonly="${readonly}">
	<acme:input-select code="authenticated.item.form.label.typeEntity" path="typeEntity">
	...
	<acme:input-textarea code="authenticated.item.form.label.code" path="code"/>
	<acme:input-textarea code="authenticated.item.form.label.technology" path="technology"/>
