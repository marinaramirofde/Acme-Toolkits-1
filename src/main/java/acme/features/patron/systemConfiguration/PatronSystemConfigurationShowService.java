...
@Service
public class PatronSystemConfigurationShowService implements AbstractShowService<Patron, SystemConfiguration>{

    @Autowired
    protected PatronSystemConfigurationRepository repository;
